const API_KEY = "3d6d478a3c56be623c4de5282b95bb17"; //add your API KEY
...
function getWeather(lat, lon) {
    fetch(
        ...
        .then(function (json) {
            ...
            const weatherDescription = json
                .weather[0]
                .description;
            const weatherIcon = json
                .weather[0]
                .icon;
            const weatherIconAdrs = `http://openweathermap.org/img/wn/${weatherIcon}@2x.png`;

            //받아온 정보들을 표현한다.
            weatherInfo.innerText = `${temperature}° (${weatherDescription})`;
